...
public class ExcelFileUtil {
	...
	{
		FileInputStream fi = new FileInputStream("D:\\Selenium_Evening\\ERP_Maven\\TestInput\\InputSheet.xlsx");
...

	{
		...
		FileOutputStream fo = new FileOutputStream("D:\\Selenium_Evening\\ERP_Maven\\TestOutput\\hybrid.xlsx");
		wb.write(fo);
		fo.close();
